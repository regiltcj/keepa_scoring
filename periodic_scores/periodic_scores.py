...
def compute_periodic_scores(bi_brand_metrics_daily, bi_product_metrics_daily, product_snapshots, products, brands):
    ...
    product_revenue_con = get_revenue_concentration(product_brand_daily, "product_id", "daily_sales")
    ...
    category_revenue_con = get_revenue_concentration(bi_brand_metrics_daily, "category_id", "daily_sales_share")
